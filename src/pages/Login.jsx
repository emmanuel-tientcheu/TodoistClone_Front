        ...
        <div className="main-container">
           ...
           <div className="form-container">
             <form action="">
               <div className="input-container">
                 <p>E-mail</p>
                 <input type="text" placeholder='Saisissez votre adresse e-mail ...' autoFocus/>
               </div>
           ...
           <div className="informations">
             ...
             <div style={{width: "400px", display: "flex", justifyContent: "center"}}>
               <p className ="information">Vous n'avez pas de compte ? <span><Link to="/signup" style={{color: "black"}}>Abonnez-vous</Link> </span></p>
             </div>
           </div>
           </div>
